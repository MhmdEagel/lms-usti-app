...
import useRegister from "./useRegisterDosen";
...
export default function RegisterMahasiswa() {
  ...
  return (
    <>
      <div className="flex flex-col items-center justify-center w-full shadow-sm py-10 px-4 lg:w-1/2">
            ...
            >
              ...
              <div>
                <p className="mb-2 text-sm">
                  Bukan Dosen? Register sebagai mahasiswa{" "}
                  <Link
