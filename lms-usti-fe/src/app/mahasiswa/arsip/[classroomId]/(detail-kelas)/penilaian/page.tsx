...
async function ArchivedStudentGradesContent({ classroomId }: { classroomId: string }) {
...
export default async function ArchivedMahasiswaPenilaianPage({
  params,
}: {
  ...
  return (
    <Suspense fallback={<StudentGradesSkeleton />}>
      <ArchivedStudentGradesContent classroomId={classroomId} />
    </Suspense>
  );
}
